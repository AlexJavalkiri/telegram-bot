...
TOKEN = os.getenv("8445348429:AAFRx8nu-1JEM_SA3IKF32C3_e6QeaGKJ2Y").build()
...
def main():
    app = Application.builder().token = os.getenv("8445348429:AAFRx8nu-1JEM_SA3IKF32C3_e6QeaGKJ2Y").build()
